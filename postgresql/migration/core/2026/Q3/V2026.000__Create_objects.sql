...
ALTER TABLE core_schema.merchant
    ADD CONSTRAINT fk_merchant_merchant_status FOREIGN KEY (status_id) REFERENCES status_schema.merchant_status (id);

ALTER TABLE core_schema.commission
    ADD CONSTRAINT fk_commission_merchant FOREIGN KEY (merchant_id) REFERENCES core_schema.merchant (id) ON DELETE RESTRICT;

ALTER TABLE core_schema.commission
    ADD CONSTRAINT fk_commission_commission_type FOREIGN KEY (type_id) REFERENCES type_schema.commission_type (id);

ALTER TABLE core_schema.invoice
    ADD CONSTRAINT fk_invoice_merchant FOREIGN KEY (merchant_id) REFERENCES core_schema.merchant (id) ON DELETE RESTRICT;

ALTER TABLE core_schema.invoice
    ADD CONSTRAINT fk_invoice_invoice_status FOREIGN KEY (status_id) REFERENCES status_schema.invoice_status (id);

ALTER TABLE core_schema.invoice
    ADD CONSTRAINT fk_invoice_ref_currency FOREIGN KEY (currency_id) REFERENCES ref_schema.ref_currency (id);

ALTER TABLE core_schema.commission_calc
    ADD CONSTRAINT fk_commission_calc_invoice FOREIGN KEY (invoice_id) REFERENCES core_schema.invoice (id);

ALTER TABLE core_schema.commission_calc
    ADD CONSTRAINT fk_commission_calc_commission FOREIGN KEY (commission_id) REFERENCES core_schema.commission (id);